...
######### Script for analyzing data doing a relax version of trimming with Trimmomatic ############
## Objective: Download raw read from NCBI and run the full RNAseq pipeline with a relaxed version of trimmomatic
...
RESULTSD=/home/$MyID/PracticeRNAseq_FullRelaxTrim/Counts_H_S_2024
REF=UCB_Xtro_10.0
